...
from torch_geometric.nn import GCNConv, global_max_pool, LayerNorm
...
class GCN(nn.Module):
    def __init__(self, dim_features, dim_pers, dim_target, num_layers,
        ...
        for i in range(self.num_layers):
            ...
            conv = GCNConv(dim_input, self.dim_node_embedding, improved=False, add_self_loops=True)
            # Overwrite aggregation method (default is set to add)
